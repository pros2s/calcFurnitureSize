...
var checkNumInputs = function checkNumInputs(selector) {
  var numInputs = document.querySelectorAll(selector); //for all numver inputs
...
var forms = function forms(state) {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      e.preventDefault(); //block of create visual message of submit process

      var statusMessage = document.createElement('div');
      statusMessage.classList.add('status');
      item.appendChild(statusMessage); //class FormData to create template of data
...
var modals = function modals() {
  ...
  var bindmodal = function bindmodal(triggerSelector, modalSelector, closSelector) {
    ...
    var trigger = document.querySelectorAll(triggerSelector),
        ...
        windows = document.querySelectorAll('[data-modal]'); //Realization of modal popup for all triggers
  ...
  var modalByTime = function modalByTime(modalSelector, time) {
    setTimeout(function () {
